...
def cal_similarity(mesh_feature, database_feature_list):
    ...
    for item in database_feature_list:
        ...
        distance_angle = scipy.stats.wasserstein_distance(instance_angle_list, angle_list)
        distance_d1 = scipy.stats.wasserstein_distance(instance_d1_list, d1_list)
        distance_d2 = scipy.stats.wasserstein_distance(instance_d2_list, d2_list)
        distance_d3 = scipy.stats.wasserstein_distance(instance_d3_list, d3_list)
        distance_d4 = scipy.stats.wasserstein_distance(instance_d4_list, d4_list)
        ...
        '''
        temp_compare.append(0.1* distance_angle)
        temp_compare.append(0.2* distance_d1)
        temp_compare.append(0.2* distance_d2)
        temp_compare.append(0.3* distance_d3)
        temp_compare.append(0.1* distance_d4)
